...
//		RdsResourcePool rdsRes = new  RdsResourcePool("10.1.245.226",50000,5000,5001,1,"root","123456",1,2000000,20,"percona_volumn/data",64,2,"cpu0,cpu1,cpu2,cpu3",100,2,22,"slp-dev");
////		rdsRes.set
...
//				"1234", 50000, 2000, 123, 500,0,"cpu0",5,"on","semisynchronous",time,time,"slp-dev");
